...
{
    public class ContactBUS : Controller
    {
            ...
            get
            {
                ...
                if (data == null)
                {
                    ...
                    for (var i = 0; i < 1000; i++)
                    {
                        ...
                        data.Add(new Contact { FirstName = first.ToString(), LastName = last.ToString(), Email = String.Format("{0}{1}@gmail.com", first, last), Id = 100 + i });
                    }
