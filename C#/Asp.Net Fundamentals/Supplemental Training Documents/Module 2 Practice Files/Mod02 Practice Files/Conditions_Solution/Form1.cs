...
// Most of the following code is automatically inserted by Visual Studio .NET
...
namespace LearningCSharp {
	...
	public class Form1 : System.Windows.Forms.Form {
		...
		// This method displays strings in the text window on the main form
		private void Output( object anyObject ) {
			richTextBox.AppendText( anyObject.ToString() + "\n" );
		}

		// This code runs when the user clicks Run
		private void run_Click(object sender, System.EventArgs e) {
			...
			if ( visitors >= 5000 ) {
				...
				Output("Visitor target not achieved");
			}
		}
	}
}
